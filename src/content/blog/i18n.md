...
If you want to view it, you can check out the [demo](https://my-portfolio-astro-c04izbv91-nhthieu.vercel.app/en/). It's still a work in progress. Or you can check out the branch on [Github](https://github.com/nhthieu/my-portfolio/tree/feature/i18n).

**Note**: It's not fully translated yet so you might see some English content here and there. And also, the Vietnamese translation is kinda cringe.
